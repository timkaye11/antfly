...
// ValidateCreate validates the InferenceProxy configuration when creating a new route.
// Called by controller fallback when webhooks are disabled.
func (r *InferenceProxy) ValidateCreate() error {
	return r.ValidateInferenceProxy()
}

// ValidateUpdate validates the InferenceProxy configuration when updating an existing route.
...
func (r *InferenceProxy) ValidateUpdate(old runtime.Object) error {
	return r.ValidateInferenceProxy()
}

// ValidateInferenceProxy performs all validation checks
func (r *InferenceProxy) ValidateInferenceProxy() error {
	...
	if len(allErrors) > 0 {
		return fmt.Errorf("InferenceProxy validation failed:\n  - %s",
...
func (r *InferenceProxy) validateRouteDestinations() error {
...
func (r *InferenceProxy) validateMatch() error {
	match := r.Spec.Match
...
func (r *InferenceProxy) validateFallback() error {
...
func (r *InferenceProxy) validateRateLimiting() error {
...
func (r *InferenceProxy) validateRetry() error {
	if r.Spec.Retry == nil {
		return nil
	}
