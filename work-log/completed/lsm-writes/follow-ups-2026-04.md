# LSM/HBC Write-Amplification Follow-Up Log (2026-04)

> Relocated verbatim from `zig/pkg/antfly/src/storage/lsm/WRITES.md` (lines 299–1269 at commit 271838a195) on 2026-09-16 during the documentation cleanup. This is a historical implementation log kept for context; the living design is [`WRITES.md`](../../../zig/pkg/antfly/src/storage/lsm/WRITES.md). Durable decisions from this log were folded into that document before the move.
>
...
11. Local production-shape guardrails.
   ...
   - Build `antfly-storage-bench antfly-storage-bench` once, then invoke their
     ...
     are in [BENCHMARKS.md](../../../zig/BENCHMARKS.md#vector-write-regression-workloads).
