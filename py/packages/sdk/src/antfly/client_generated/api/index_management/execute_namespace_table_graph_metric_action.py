...
from ...models.execute_namespace_table_graph_metric_action_action import ExecuteNamespaceTableGraphMetricActionAction
...
def _get_kwargs(
    ...
    index_name: str,
    metric_name: str,
    action: ExecuteNamespaceTableGraphMetricActionAction,
) -> dict[str, Any]:

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/db/v1/databases/{database_name}/namespaces/{namespace_name}/tables/{table_name}/indexes/{index_name}/graph-metrics/{metric_name}:{action}".format(
