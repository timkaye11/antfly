...
from ...models.transaction_stage_delete_request import TransactionStageDeleteRequest
...
def _get_kwargs(
    transaction_id: str,
    *,
    body: TransactionStageDeleteRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/transactions/{transaction_id}/delete".format(
