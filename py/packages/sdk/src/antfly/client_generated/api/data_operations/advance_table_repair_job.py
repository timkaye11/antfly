...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/db/v1/tables/{table_name}/repair/jobs/{job_id}/advance".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Advance a table repair job
     ...
     Runs at most one bounded repair pass for the job. Concurrent advances use the job lease and return
