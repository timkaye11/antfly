...
from ...models.inference_transcription_session_deleted import InferenceTranscriptionSessionDeleted
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/ai/v1/transcription/sessions/{session_id}".format(
...
) -> InferenceError | InferenceTranscriptionSessionDeleted | None:
    if response.status_code == 200:
        response_200 = InferenceTranscriptionSessionDeleted.from_dict(response.json())
