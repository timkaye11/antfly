...
from ..models.extraction_constraint_or_type import ExtractionConstraintOrType
...
T = TypeVar("T", bound="ExtractionConstraintOr")


@_attrs_define
class ExtractionConstraintOr:
    """
    Attributes:
        type_ (ExtractionConstraintOrType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = ExtractionConstraintOrType(d.pop("type"))
        ...
        extraction_constraint_or = cls(
            type_=type_,
            children=children,
        )

        return extraction_constraint_or
