...
T = TypeVar("T", bound="TermiteBinaryContent")


@_attrs_define
class TermiteBinaryContent:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        termite_binary_content.additional_properties = d
        return termite_binary_content
