...
T = TypeVar("T", bound="InferenceModelsResponseClassifiers")


@_attrs_define
class InferenceModelsResponseClassifiers:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        inference_models_response_classifiers = cls()
        ...
        inference_models_response_classifiers.additional_properties = additional_properties
        return inference_models_response_classifiers
