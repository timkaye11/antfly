...
T = TypeVar("T", bound="InferenceModelsResponseEmbedders")


@_attrs_define
class InferenceModelsResponseEmbedders:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        inference_models_response_embedders = cls()
        ...
        inference_models_response_embedders.additional_properties = additional_properties
        return inference_models_response_embedders
