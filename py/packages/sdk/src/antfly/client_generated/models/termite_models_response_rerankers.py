...
T = TypeVar("T", bound="TermiteModelsResponseRerankers")


@_attrs_define
class TermiteModelsResponseRerankers:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        termite_models_response_rerankers = cls()
        ...
        termite_models_response_rerankers.additional_properties = additional_properties
        return termite_models_response_rerankers
