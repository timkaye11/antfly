...
T = TypeVar("T", bound="TermiteRecognizeEntity")


@_attrs_define
class TermiteRecognizeEntity:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        termite_recognize_entity.additional_properties = d
        return termite_recognize_entity
