...
T = TypeVar("T", bound="TermiteModelsResponseReaders")


@_attrs_define
class TermiteModelsResponseReaders:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        termite_models_response_readers = cls()
        ...
        termite_models_response_readers.additional_properties = additional_properties
        return termite_models_response_readers
