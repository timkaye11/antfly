...
T = TypeVar("T", bound="TermiteModelsResponseGenerators")


@_attrs_define
class TermiteModelsResponseGenerators:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        termite_models_response_generators = cls()
        ...
        termite_models_response_generators.additional_properties = additional_properties
        return termite_models_response_generators
