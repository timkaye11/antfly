...
T = TypeVar("T", bound="TermiteReadRequest")


@_attrs_define
class TermiteReadRequest:
    """
    Attributes:
        model (str): Name of reader model from models_dir/readers/ Example: microsoft/trocr-base-printed.
        images (list[TermiteImageURL]): Images to read text from. Supports:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        termite_read_request.additional_properties = d
        return termite_read_request
