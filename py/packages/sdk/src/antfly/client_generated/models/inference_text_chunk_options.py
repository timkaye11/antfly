...
T = TypeVar("T", bound="InferenceTextChunkOptions")


@_attrs_define
class InferenceTextChunkOptions:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        inference_text_chunk_options = cls(
            target_tokens=target_tokens,
            overlap_tokens=overlap_tokens,
            separator=separator,
        )

        inference_text_chunk_options.additional_properties = d
        return inference_text_chunk_options
