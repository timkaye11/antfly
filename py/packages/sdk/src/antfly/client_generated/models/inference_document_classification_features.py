...
T = TypeVar("T", bound="InferenceDocumentClassificationFeatures")


@_attrs_define
class InferenceDocumentClassificationFeatures:
    """
    Attributes:
        num_tokens (int):
        image_width (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        inference_document_classification_features = cls(
            num_tokens=num_tokens,
            image_width=image_width,
            image_height=image_height,
            image_components=image_components,
        ...
        inference_document_classification_features.additional_properties = d
        return inference_document_classification_features
