...
if TYPE_CHECKING:
    from ..models.inference_document_token_box import InferenceDocumentTokenBox


T = TypeVar("T", bound="InferenceDocumentTokenClassificationRequest")


@_attrs_define
class InferenceDocumentTokenClassificationRequest:
    """
    Attributes:
        ...
        labels (list[str]): Labels in the same order expected by the checkpoint output head Example: ['O', 'B-KEY',
            'I-KEY'].
        tokens (list[InferenceDocumentTokenBox]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for tokens_item_data in _tokens:
            tokens_item = InferenceDocumentTokenBox.from_dict(tokens_item_data)

            tokens.append(tokens_item)

        prefix = d.pop("prefix", UNSET)

        inference_document_token_classification_request = cls(
            model=model,
            labels=labels,
            tokens=tokens,
            prefix=prefix,
        ...
        inference_document_token_classification_request.additional_properties = d
        return inference_document_token_classification_request
