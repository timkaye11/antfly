...
T = TypeVar("T", bound="InferenceModelsResponseExtractors")


@_attrs_define
class InferenceModelsResponseExtractors:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        inference_models_response_extractors = cls()
        ...
        inference_models_response_extractors.additional_properties = additional_properties
        return inference_models_response_extractors
