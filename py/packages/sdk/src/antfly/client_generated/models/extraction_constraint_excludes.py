...
from ..models.extraction_constraint_excludes_type import ExtractionConstraintExcludesType
...
T = TypeVar("T", bound="ExtractionConstraintExcludes")


@_attrs_define
class ExtractionConstraintExcludes:
    """
    Attributes:
        type_ (ExtractionConstraintExcludesType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = ExtractionConstraintExcludesType(d.pop("type"))
        ...
        extraction_constraint_excludes = cls(
            type_=type_,
            left=left,
            right=right,
        )

        return extraction_constraint_excludes
