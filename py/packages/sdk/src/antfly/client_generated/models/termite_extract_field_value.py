...
T = TypeVar("T", bound="TermiteExtractFieldValue")


@_attrs_define
class TermiteExtractFieldValue:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        termite_extract_field_value = cls(
            value=value,
            score=score,
            start=start,
            end=end,
        ...
        termite_extract_field_value.additional_properties = d
        return termite_extract_field_value
