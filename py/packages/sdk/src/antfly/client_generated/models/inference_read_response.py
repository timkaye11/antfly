...
T = TypeVar("T", bound="InferenceReadResponse")


@_attrs_define
class InferenceReadResponse:
    """
    Attributes:
        object_ (InferenceReadResponseObject): Object type, always "list"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        object_ = InferenceReadResponseObject(d.pop("object"))

        data = []
        _data = d.pop("data")
        for data_item_data in _data:
            data_item = InferenceReadObject.from_dict(data_item_data)
        ...
        return inference_read_response
