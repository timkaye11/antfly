...
T = TypeVar("T", bound="InferenceRewriteRequest")


@_attrs_define
class InferenceRewriteRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        inference_rewrite_request = cls(
            model=model,
            inputs=inputs,
        )

        inference_rewrite_request.additional_properties = d
        return inference_rewrite_request
