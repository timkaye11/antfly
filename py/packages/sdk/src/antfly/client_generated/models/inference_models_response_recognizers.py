...
T = TypeVar("T", bound="InferenceModelsResponseRecognizers")


@_attrs_define
class InferenceModelsResponseRecognizers:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        inference_models_response_recognizers = cls()
        ...
        inference_models_response_recognizers.additional_properties = additional_properties
        return inference_models_response_recognizers
