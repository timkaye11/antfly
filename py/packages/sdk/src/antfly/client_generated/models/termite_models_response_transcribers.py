...
T = TypeVar("T", bound="TermiteModelsResponseTranscribers")


@_attrs_define
class TermiteModelsResponseTranscribers:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        termite_models_response_transcribers = cls()
        ...
        termite_models_response_transcribers.additional_properties = additional_properties
        return termite_models_response_transcribers
