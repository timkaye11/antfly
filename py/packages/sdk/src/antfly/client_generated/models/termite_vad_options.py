...
T = TypeVar("T", bound="TermiteVADOptions")


@_attrs_define
class TermiteVADOptions:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        termite_vad_options.additional_properties = d
        return termite_vad_options
