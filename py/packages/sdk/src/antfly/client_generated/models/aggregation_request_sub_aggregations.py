...
T = TypeVar("T", bound="AggregationRequestSubAggregations")


@_attrs_define
class AggregationRequestSubAggregations:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        aggregation_request_sub_aggregations = cls()
        ...
        aggregation_request_sub_aggregations.additional_properties = additional_properties
        return aggregation_request_sub_aggregations
