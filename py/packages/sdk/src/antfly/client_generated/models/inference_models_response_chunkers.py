...
T = TypeVar("T", bound="InferenceModelsResponseChunkers")


@_attrs_define
class InferenceModelsResponseChunkers:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        inference_models_response_chunkers = cls()
        ...
        inference_models_response_chunkers.additional_properties = additional_properties
        return inference_models_response_chunkers
