...
T = TypeVar("T", bound="InferenceModelsResponseRewriters")


@_attrs_define
class InferenceModelsResponseRewriters:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        inference_models_response_rewriters = cls()
        ...
        inference_models_response_rewriters.additional_properties = additional_properties
        return inference_models_response_rewriters
