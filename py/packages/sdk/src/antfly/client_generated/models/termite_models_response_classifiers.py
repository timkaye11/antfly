...
T = TypeVar("T", bound="TermiteModelsResponseClassifiers")


@_attrs_define
class TermiteModelsResponseClassifiers:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        termite_models_response_classifiers = cls()
        ...
        termite_models_response_classifiers.additional_properties = additional_properties
        return termite_models_response_classifiers
