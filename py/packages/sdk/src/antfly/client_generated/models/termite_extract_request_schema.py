...
T = TypeVar("T", bound="TermiteExtractRequestSchema")


@_attrs_define
class TermiteExtractRequestSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        termite_extract_request_schema = cls()
        ...
        termite_extract_request_schema.additional_properties = additional_properties
        return termite_extract_request_schema
