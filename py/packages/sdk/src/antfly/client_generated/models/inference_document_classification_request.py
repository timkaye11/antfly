...
T = TypeVar("T", bound="InferenceDocumentClassificationRequest")


@_attrs_define
class InferenceDocumentClassificationRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        inference_document_classification_request = cls(
            model=model,
            image_path=image_path,
            num_tokens=num_tokens,
            labels=labels,
        ...
        inference_document_classification_request.additional_properties = d
        return inference_document_classification_request
