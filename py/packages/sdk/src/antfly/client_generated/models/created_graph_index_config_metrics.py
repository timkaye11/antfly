...
T = TypeVar("T", bound="CreatedGraphIndexConfigMetrics")


@_attrs_define
class CreatedGraphIndexConfigMetrics:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        created_graph_index_config_metrics = cls()
        ...
        created_graph_index_config_metrics.additional_properties = additional_properties
        return created_graph_index_config_metrics
