...
T = TypeVar("T", bound="TermiteTextRegion")


@_attrs_define
class TermiteTextRegion:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        termite_text_region.additional_properties = d
        return termite_text_region
