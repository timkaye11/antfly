...
from ..models.open_router_generator_config_provider import OpenRouterGeneratorConfigProvider
...
class OpenRouterGeneratorConfig:
    ...
    Attributes:
        provider (OpenRouterGeneratorConfigProvider):
        model (str): The OpenRouter model identifier to use. Example: openai/gpt-4.1.
        url (str | Unset): The URL of the OpenRouter API endpoint. Default: 'https://openrouter.ai/api/v1'.
    ...
    provider: OpenRouterGeneratorConfigProvider
    model: str
    url: str | Unset = "https://openrouter.ai/api/v1"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        provider = OpenRouterGeneratorConfigProvider(d.pop("provider"))
