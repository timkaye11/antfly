...
T = TypeVar("T", bound="TermiteCredentials")


@_attrs_define
class TermiteCredentials:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        termite_credentials.additional_properties = d
        return termite_credentials
