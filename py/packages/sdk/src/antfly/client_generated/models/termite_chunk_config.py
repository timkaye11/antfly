...
if TYPE_CHECKING:
    from ..models.termite_audio_chunk_config import TermiteAudioChunkConfig
    from ..models.termite_text_chunk_options import TermiteTextChunkOptions


T = TypeVar("T", bound="TermiteChunkConfig")


@_attrs_define
class TermiteChunkConfig:
    ...
    Combines shared text options with Termite-specific audio/VAD options.
        ...
        Attributes:
            ...
            threshold (float | Unset): Confidence threshold for model-based chunking (0.0-1.0). Used by ONNX text models and
                VAD audio models.
            text (TermiteTextChunkOptions | Unset): Options specific to text chunking.
            audio (TermiteAudioChunkConfig | Unset): Audio chunking configuration for Termite, including VAD options.
    """

    model: str | Unset = "fixed"
    max_chunks: int | Unset = UNSET
    threshold: float | Unset = UNSET
    text: TermiteTextChunkOptions | Unset = UNSET
    audio: TermiteAudioChunkConfig | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text: TermiteTextChunkOptions | Unset
        if isinstance(_text, Unset):
            text = UNSET
        else:
            text = TermiteTextChunkOptions.from_dict(_text)

        _audio = d.pop("audio", UNSET)
        audio: TermiteAudioChunkConfig | Unset
        if isinstance(_audio, Unset):
            audio = UNSET
        else:
            audio = TermiteAudioChunkConfig.from_dict(_audio)

        termite_chunk_config = cls(
            model=model,
        ...
        termite_chunk_config.additional_properties = d
        return termite_chunk_config
