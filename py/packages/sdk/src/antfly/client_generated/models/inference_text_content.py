...
T = TypeVar("T", bound="InferenceTextContent")


@_attrs_define
class InferenceTextContent:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        inference_text_content = cls(
            text=text,
            start_char=start_char,
            end_char=end_char,
        )

        inference_text_content.additional_properties = d
        return inference_text_content
