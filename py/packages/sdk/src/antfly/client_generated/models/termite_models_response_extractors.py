...
T = TypeVar("T", bound="TermiteModelsResponseExtractors")


@_attrs_define
class TermiteModelsResponseExtractors:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        termite_models_response_extractors = cls()
        ...
        termite_models_response_extractors.additional_properties = additional_properties
        return termite_models_response_extractors
