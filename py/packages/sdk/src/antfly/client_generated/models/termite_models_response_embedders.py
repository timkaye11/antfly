...
T = TypeVar("T", bound="TermiteModelsResponseEmbedders")


@_attrs_define
class TermiteModelsResponseEmbedders:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        termite_models_response_embedders = cls()
        ...
        termite_models_response_embedders.additional_properties = additional_properties
        return termite_models_response_embedders
