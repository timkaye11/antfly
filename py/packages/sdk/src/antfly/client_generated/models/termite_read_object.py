...
from ..models.termite_read_object_object import TermiteReadObjectObject
...
T = TypeVar("T", bound="TermiteReadObject")


@_attrs_define
class TermiteReadObject:
    """
    Attributes:
        text (str): Extracted text from the image Example: Invoice Total: $123.45.
        object_ (TermiteReadObjectObject):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        object_ = TermiteReadObjectObject(d.pop("object"))
        ...
        termite_read_object.additional_properties = d
        return termite_read_object
