...
T = TypeVar("T", bound="TermiteModelsResponseRecognizers")


@_attrs_define
class TermiteModelsResponseRecognizers:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        termite_models_response_recognizers = cls()
        ...
        termite_models_response_recognizers.additional_properties = additional_properties
        return termite_models_response_recognizers
