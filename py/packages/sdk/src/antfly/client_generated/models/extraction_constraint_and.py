...
from ..models.extraction_constraint_and_type import ExtractionConstraintAndType
...
T = TypeVar("T", bound="ExtractionConstraintAnd")


@_attrs_define
class ExtractionConstraintAnd:
    """
    Attributes:
        type_ (ExtractionConstraintAndType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = ExtractionConstraintAndType(d.pop("type"))
        ...
        extraction_constraint_and = cls(
            type_=type_,
            children=children,
        )

        return extraction_constraint_and
