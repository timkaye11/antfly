...
from ..models.termite_chunk_response_object import TermiteChunkResponseObject

if TYPE_CHECKING:
    from ..models.termite_chunk_object import TermiteChunkObject
    from ..models.termite_generate_usage import TermiteGenerateUsage


T = TypeVar("T", bound="TermiteChunkResponse")


@_attrs_define
class TermiteChunkResponse:
    """
    Example:
    ...
    Attributes:
        object_ (TermiteChunkResponseObject): Object type, always "list"
        data (list[TermiteChunkObject]): Array of chunk objects
    ...
    object_: TermiteChunkResponseObject
    data: list[TermiteChunkObject]
    model: str
    usage: TermiteGenerateUsage
    cache_hit: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        object_ = TermiteChunkResponseObject(d.pop("object"))

        data = []
        _data = d.pop("data")
        for data_item_data in _data:
            data_item = TermiteChunkObject.from_dict(data_item_data)
        ...
        termite_chunk_response.additional_properties = d
        return termite_chunk_response
