...
if TYPE_CHECKING:
    from ..models.termite_extract_request_schema import TermiteExtractRequestSchema
    from ..models.termite_image_url import TermiteImageURL


T = TypeVar("T", bound="TermiteExtractRequest")


@_attrs_define
class TermiteExtractRequest:
    ...
    and processes the request as: read document text -> run structured extraction.
        ...
        Attributes:
            ...
            schema (TermiteExtractRequestSchema): Extraction schema mapping structure names to field definitions.
            ...
            texts (list[str] | Unset): Texts to extract structured data from Example: ['John Smith is 30 years old and works
                at Google.'].
            images (list[TermiteImageURL] | Unset): Optional images to extract structured data from.
    ...
    model: str
    schema: TermiteExtractRequestSchema
    texts: list[str] | Unset = UNSET
    images: list[TermiteImageURL] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        schema = TermiteExtractRequestSchema.from_dict(d.pop("schema"))
        ...
        if _images is not UNSET:
            ...
            for images_item_data in _images:
                images_item = TermiteImageURL.from_dict(images_item_data)
        ...
        termite_extract_request.additional_properties = d
        return termite_extract_request
