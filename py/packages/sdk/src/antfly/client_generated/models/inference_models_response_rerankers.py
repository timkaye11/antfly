...
T = TypeVar("T", bound="InferenceModelsResponseRerankers")


@_attrs_define
class InferenceModelsResponseRerankers:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        inference_models_response_rerankers = cls()
        ...
        inference_models_response_rerankers.additional_properties = additional_properties
        return inference_models_response_rerankers
