...
class InferenceConfig:
    ...
    Attributes:
        ...
        allow_downloads (bool | Unset): Legacy compatibility field. Download-command availability is a build-time
            setting in the current Zig runtime; configuring this field has no effect.
