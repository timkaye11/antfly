...
T = TypeVar("T", bound="InferenceModelsResponseGenerators")


@_attrs_define
class InferenceModelsResponseGenerators:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        inference_models_response_generators = cls()
        ...
        inference_models_response_generators.additional_properties = additional_properties
        return inference_models_response_generators
