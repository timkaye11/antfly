...
T = TypeVar("T", bound="InferenceModelsResponseTranscribers")


@_attrs_define
class InferenceModelsResponseTranscribers:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        inference_models_response_transcribers = cls()
        ...
        inference_models_response_transcribers.additional_properties = additional_properties
        return inference_models_response_transcribers
