...
T = TypeVar("T", bound="QueryResultBaseGraphMetricResults")


@_attrs_define
class QueryResultBaseGraphMetricResults:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        query_result_base_graph_metric_results = cls()
        ...
        query_result_base_graph_metric_results.additional_properties = additional_properties
        return query_result_base_graph_metric_results
