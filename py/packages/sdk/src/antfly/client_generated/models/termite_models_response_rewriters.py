...
T = TypeVar("T", bound="TermiteModelsResponseRewriters")


@_attrs_define
class TermiteModelsResponseRewriters:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        termite_models_response_rewriters = cls()
        ...
        termite_models_response_rewriters.additional_properties = additional_properties
        return termite_models_response_rewriters
