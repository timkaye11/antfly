...
T = TypeVar("T", bound="TermiteContentSecurityConfig")


@_attrs_define
class TermiteContentSecurityConfig:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        termite_content_security_config = cls(
        ...
        termite_content_security_config.additional_properties = d
        return termite_content_security_config
