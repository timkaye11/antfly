...
T = TypeVar("T", bound="InferenceSparseVector")


@_attrs_define
class InferenceSparseVector:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        inference_sparse_vector = cls(
            indices=indices,
            values=values,
        )

        inference_sparse_vector.additional_properties = d
        return inference_sparse_vector
