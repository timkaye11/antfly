...
if TYPE_CHECKING:
    from ..models.sse_step_completed_details import SSEStepCompletedDetails


T = TypeVar("T", bound="SSEStepCompleted")


@_attrs_define
class SSEStepCompleted:
    ...
    Attributes:
        ...
        details (SSEStepCompletedDetails | Unset): Additional details about the step
    """
    ...
    details: SSEStepCompletedDetails | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        details: SSEStepCompletedDetails | Unset
        if isinstance(_details, Unset):
            details = UNSET
        else:
            details = SSEStepCompletedDetails.from_dict(_details)

        sse_step_completed = cls(
            name=name,
            action=action,
            id=id,
            kind=kind,
        ...
        sse_step_completed.additional_properties = d
        return sse_step_completed
