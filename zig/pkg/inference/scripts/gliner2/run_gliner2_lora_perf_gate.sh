...
usage() {
  cat <<'EOF'
Usage:
  scripts/gliner2/run_gliner2_lora_perf_gate.sh [options] [-- extra compare args]
...
Examples:
  scripts/gliner2/run_gliner2_lora_perf_gate.sh --op-stats --max-host-output-median 388
  scripts/gliner2/run_gliner2_lora_perf_gate.sh --include-python --require-zig-beats-python
EOF
}
