...
common_antfly_env=(
  ...
  ANTFLY_INFERENCE_CUDA_Q4_0_GATE_UP_ACTIVATION_Q8_1_PRECOMPUTE="$antfly_q4_0_gate_up_activation_q8_1_precompute"
  ...
  ANTFLY_INFERENCE_CUDA_PROFILE_DECODE="$antfly_cuda_profile_decode"
  ...
  ANTFLY_INFERENCE_CUDA_DECODE_GRAPH_REPLAY="$antfly_decode_graph_replay"
...
if [[ "$antfly_decode_graph_replay" == "off" || "$antfly_decode_graph_replay" == "0" ]]; then
  common_antfly_env+=(
...
summary["ok"] = summary["ok_total"] and summary["ok_prefill"] and summary["ok_decode"] and summary["ok_qat_prefill_rows4"] and summary["ok_qat_prefill_rows16_c1"] and summary["ok_qat_prefill_linear_rows8_c4"] and summary["ok_llama_throughput_ratio"]
