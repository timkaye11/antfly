...
with (out_dir / "summary.tsv").open("w", encoding="utf-8") as f:
    ...
    for r in rows:
        f.write(
            ...
            f"{r['gen_q6_small_batch']}\t{r['active_decode_layers']}\t"
