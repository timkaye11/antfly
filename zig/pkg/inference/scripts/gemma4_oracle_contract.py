...
BENCHMARK_PRODUCER_RELATIVE_PATHS = (
    "zig/pkg/inference/scripts/bench_gemma4_lora_mlx_zig.py",
    "zig/pkg/inference/scripts/build_and_attest_gemma4_mlx.py",
    "zig/pkg/inference/scripts/gemma4_oracle.lock.json",
    "zig/pkg/inference/scripts/gemma4_oracle_contract.py",
    "zig/pkg/inference/scripts/requirements-gemma4-mlx-reference.txt",
    "zig/pkg/inference/scripts/run_antfly_gemma4_lora_benchmark.py",
    "zig/pkg/inference/scripts/run_gemma4_lora_benchmark_campaign.py",
