...
def main() -> None:
    ...
    matrix_path = args.output_dir / "e2b/matrix_summary.json"
    matrix: dict[str, Any] = {}
    ...
    elif matrix_returncode != 0:
        errors.append(f"E2B matrix exited {matrix_returncode}")

    pair_path = args.output_dir / f"e2b/tokens-{E2B_LLAMA_TOKENS}/paired_summary.json"
    pair: dict[str, Any] = {}
    ...
    if matrix_returncode != 0 and not (args.enforce_performance and matrix):
        errors.append(f"E2B matrix exited {matrix_returncode}")
