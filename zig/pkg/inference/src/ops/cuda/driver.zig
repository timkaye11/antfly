...
pub const CudaDriver = struct {
    ...
    pub const Table = struct {
        ...
        cuModuleGetGlobal: *const fn (dptr: *CUdeviceptr, bytes: *usize, hmod: CUmodule, name: [*:0]const u8) callconv(.c) CUresult,
    ...
    pub fn open() Error!CudaDriver {
        ...
        return .{
            ...
            .fns = .{
                ...
                .cuModuleGetGlobal = lookup(&lib, @TypeOf(@as(Table, undefined).cuModuleGetGlobal), "cuModuleGetGlobal_v2") catch return error.CudaSymbolMissing,
