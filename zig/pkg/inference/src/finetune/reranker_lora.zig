...
pub const vocab_json_file_name = assets.vocab_json_file_name;
pub const merges_txt_file_name = assets.merges_txt_file_name;
...
const parseEncoderLayerIndex = assets.parseEncoderLayerIndex;
