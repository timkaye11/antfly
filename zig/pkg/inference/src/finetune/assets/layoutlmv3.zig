...
pub fn moduleNameForTensor(tensor_name: []const u8) ?[]const u8 {
...
pub fn parseLoRAAdapterTensorName(tensor_name: []const u8) ?ParsedLoRAAdapterTensorName {
...
pub fn requiredPathInDir(allocator: std.mem.Allocator, dir_path: []const u8, basename: []const u8) ![]u8 {
    return (try optionalPathInDir(allocator, dir_path, basename)) orelse error.FileNotFound;
}

pub fn optionalPathInDir(allocator: std.mem.Allocator, dir_path: []const u8, basename: []const u8) !?[]u8 {
...
pub fn dupeStringSlice(allocator: std.mem.Allocator, value: []const []const u8) ![][]const u8 {
