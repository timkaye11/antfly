...
const assets = @import("assets/reranker_head.zig");
...
pub const head_checkpoint_file_name = assets.head_checkpoint_file_name;
pub const head_config_file_name = assets.head_config_file_name;
pub const merged_head_checkpoint_file_name = assets.merged_head_checkpoint_file_name;
pub const RerankerHead = assets.RerankerHead;
pub const resolveModelHiddenSize = assets.resolveModelHiddenSize;
pub const initHeadFromModelDir = assets.initHeadFromModelDir;
pub const saveHead = assets.saveHead;
pub const materializeMergedHead = assets.materializeMergedHead;
pub const loadHeadIfPresent = assets.loadHeadIfPresent;
pub const loadHeadFromInput = assets.loadHeadFromInput;
pub const materializeHeadFromDir = assets.materializeHeadFromDir;
