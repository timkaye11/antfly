...
fn usage() error{InvalidArguments}!void {
    print(
        \\usage: train-eval-reranker-head-cached <model-dir> <train-cache-json> <eval-cache-json> <out-dir> [--backend auto|native|mlx] [--max-examples N] [--epochs N] [--learning-rate LR]
