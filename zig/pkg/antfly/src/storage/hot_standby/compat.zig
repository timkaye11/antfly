...
test "storage.hot_standby compat decodes v1 replication record fixture" {
    const decoded = try replication_record.decode(&v1_encoded);

    try expectRecordEqual(v1_record, decoded);
}

test "storage.hot_standby compat keeps v1 replication record encoding stable" {
...
test "storage.hot_standby compat decodes v1 timeline switch record fixture" {
...
test "storage.hot_standby compat keeps v1 timeline switch encoding stable" {
...
test "storage.hot_standby compat decodes v1 base backup and checkpoint record fixtures" {
...
test "storage.hot_standby compat keeps v1 base backup and checkpoint encodings stable" {
...
test "storage.hot_standby compat decodes v1 backup manifest fixture" {
...
test "storage.hot_standby compat keeps v1 backup manifest encoding stable" {
...
test "storage.hot_standby compat keeps v1 backup manifest file kind tags stable" {
...
test "storage.hot_standby compat keeps v1 record kind tags stable" {
