...
test "storage.hot_standby admin exec runs slot lifecycle and status commands" {
...
test "storage.hot_standby admin exec renders operator plan command" {
    const alloc = std.testing.allocator;
...
test "storage.hot_standby admin exec operator plan assesses former primary rejoin" {
    const alloc = std.testing.allocator;
...
test "storage.hot_standby admin exec executes former primary rejoin rewind and reseed commands" {
    const alloc = std.testing.allocator;
...
test "storage.hot_standby admin exec finishes and bootstraps seed manifests from files" {
    const alloc = std.testing.allocator;
...
test "storage.hot_standby admin exec streams one local replication session" {
    const alloc = std.testing.allocator;
...
test "storage.hot_standby admin exec runs read commit promote and rejoin commands" {
    const alloc = std.testing.allocator;
