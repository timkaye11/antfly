...
test "storage.hot_standby standby apply window has independent work and time bounds" {
...
test "storage.hot_standby standby rejects invalid open identity" {
...
test "storage.hot_standby standby allows whole instance shard table identity" {
    const alloc = std.testing.allocator;
...
test "storage.hot_standby standby whole instance identity accepts mixed table records across reopen" {
    const alloc = std.testing.allocator;
    const identity = Identity{ .cluster_id = 10, .shard_id = 0, .table_id = 0, .timeline_id = 1, .epoch = 1 };
...
test "storage.hot_standby standby snapshots do not wait behind the operation lease" {
    const alloc = std.testing.allocator;
...
test "storage.hot_standby standby path observation is fenced after consumption" {
    const alloc = std.testing.allocator;
    const identity = Identity{ .cluster_id = 10, .timeline_id = 1, .epoch = 1 };
...
test "storage.hot_standby standby receives applies and persists progress across reopen" {
    const alloc = std.testing.allocator;
...
test "storage.hot_standby standby replays received wal after crash before apply" {
    const alloc = std.testing.allocator;
    const identity = Identity{ .cluster_id = 10, .shard_id = 20, .table_id = 30, .timeline_id = 1, .epoch = 1 };
...
test "storage.hot_standby standby rejects wrong identity and receive gaps" {
    const alloc = std.testing.allocator;
    const identity = Identity{ .cluster_id = 10, .shard_id = 20, .table_id = 30, .timeline_id = 1, .epoch = 1 };
...
test "storage.hot_standby standby follows promoted timeline switch after applying parent timeline" {
    const alloc = std.testing.allocator;
...
test "storage.hot_standby standby receive retry reconciles durable record when progress lags" {
    const alloc = std.testing.allocator;
    const identity = Identity{ .cluster_id = 10, .shard_id = 20, .table_id = 30, .timeline_id = 1, .epoch = 1 };
...
test "storage.hot_standby standby does not advance applied lsn when apply fails" {
    const alloc = std.testing.allocator;
    const identity = Identity{ .cluster_id = 10, .shard_id = 20, .table_id = 30, .timeline_id = 1, .epoch = 1 };
...
test "storage.hot_standby promoted standby handoff truncates unapplied received records after switch" {
    const alloc = std.testing.allocator;
    const identity = Identity{ .cluster_id = 10, .shard_id = 20, .table_id = 30, .timeline_id = 1, .epoch = 1 };
...
test "storage.hot_standby standby forced promotion records possible data loss" {
    const alloc = std.testing.allocator;
    const identity = Identity{ .cluster_id = 10, .shard_id = 20, .table_id = 30, .timeline_id = 1, .epoch = 1 };
...
test "storage.hot_standby promoted standby reopens on new timeline and rejects old timeline" {
    const alloc = std.testing.allocator;
    const identity = Identity{ .cluster_id = 10, .shard_id = 20, .table_id = 30, .timeline_id = 1, .epoch = 1 };
...
test "storage.hot_standby standby recovers timeline switch when promotion progress lags" {
    const alloc = std.testing.allocator;
    const identity = Identity{ .cluster_id = 10, .shard_id = 20, .table_id = 30, .timeline_id = 1, .epoch = 1 };
    const promoted_identity = Identity{ .cluster_id = 10, .shard_id = 20, .table_id = 30, .timeline_id = 2, .epoch = 2 };
