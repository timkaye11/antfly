...
test "storage.hot_standby validation checks paths are bounded by an allowed root" {
...
test "storage.hot_standby validation parses URLs and rejects hidden whitespace" {
