...
test "storage.hot_standby fencing persists promotion receipt and builds promotion request" {
...
test "storage.hot_standby fencing rejects unsafe and competing promotions" {
    const alloc = std.testing.allocator;
...
test "storage.hot_standby fencing rejects invalid node identifiers" {
    const alloc = std.testing.allocator;
...
test "storage.hot_standby fencing rejects conflicting duplicate generations on replay" {
    const alloc = std.testing.allocator;
...
test "storage.hot_standby fencing rejects stale parent generation on replay" {
    const alloc = std.testing.allocator;
...
test "storage.hot_standby fencing rejects invalid durable receipt fields on replay" {
    const alloc = std.testing.allocator;
...
test "storage.hot_standby fencing allocates generation 1 when omitted on empty store" {
    const alloc = std.testing.allocator;
...
test "storage.hot_standby fencing allocates held generation plus one for omitted chained fence" {
    const alloc = std.testing.allocator;
...
test "storage.hot_standby fencing omitted generation retry is idempotent" {
    const alloc = std.testing.allocator;
...
test "storage.hot_standby fencing rejects stale explicit generation after omitted allocation" {
    const alloc = std.testing.allocator;
...
test "storage.hot_standby fencing rejects generation allocation overflow" {
    const alloc = std.testing.allocator;
...
test "storage.hot_standby fencing receipt drives standby promotion" {
    const alloc = std.testing.allocator;
