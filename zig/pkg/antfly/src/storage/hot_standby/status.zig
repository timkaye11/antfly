...
test "storage.hot_standby status snapshots primary slot lag retention and sync policy" {
...
test "storage.hot_standby status snapshots standby lag and promotion readiness" {
    const alloc = std.testing.allocator;
