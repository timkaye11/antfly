...
pub const RequestControl = auth.RequestControl;
...
pub const projectIdFromDefaultCredentialsAllocWithControl = auth.projectIdFromDefaultCredentialsAllocWithControl;
