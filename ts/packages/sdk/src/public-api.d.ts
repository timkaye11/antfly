...
export interface components {
    schemas: {
        ...
        InferenceConfig: {
            ...
            /**
             * @deprecated
             * @description Legacy compatibility field. The current Zig runtime ignores per-model
            ...
            /**
             * @deprecated
             * @description Legacy compatibility field. Download-command availability is a build-time
             *     setting in the current Zig runtime; configuring this field has no effect.
             */
            allow_downloads?: boolean;
            /**
             * @deprecated
             * @description Legacy inference-local logging field. The current unified Zig runtime
        ...
        InferenceContentSecurityConfig: {
            /**
             * @description Explicit hostname/IP allowlist for inference link downloads. Omission and an explicit empty list both deny all hosts; block_private_ips applies in addition to this allowlist.
             * @example [
             *       "example.com",
             *       "cdn.example.com",
             *       "192.0.2.1"
            ...
            allowed_hosts?: string[];
            /**
             * @description Block non-global IP literals, including loopback, private, link-local, carrier-grade NAT, reserved, and multicast ranges. DNS results are not currently pinned or revalidated; use an allowlist and network egress controls for untrusted deployments.
             * @default true
             */
            block_private_ips?: boolean;
            /**
