  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          // chassis surface — square, flat, strong border on the edge facing content.
          // No gap: header / body / footer own their separators via internal borders.
...
function SheetBody({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex-1 overflow-y-auto px-[18px] py-[18px] text-sm text-foreground",
        className
      )}
      {...props}
    />
